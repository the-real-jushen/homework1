...
def conv_layer(input, in_channel, out_channel):
    ...
    conv = tf.nn.conv2d(input, w, strides=[1, 1, 1, 1], padding="SAME") #what does the last 2 stride no. mean? padding stratigy?
...
def inference(image, keep_prob):
    ...
    conv1_pool = tf.nn.max_pool(conv1, ksize=[1,2,2,1], strides=[1,2,2,1], padding="SAME") #same question as above
    # conv2
